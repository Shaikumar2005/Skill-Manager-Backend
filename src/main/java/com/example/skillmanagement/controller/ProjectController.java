...
public class ProjectController {
    ...
    public ResponseEntity<SkillGapResponse> gapForCurrentUser(@PathVariable Long projectId, Authentication auth) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<SkillGapResponse> gapForUser(@PathVariable Long projectId, @PathVariable Long userId) {
